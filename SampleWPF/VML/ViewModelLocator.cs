...
namespace SampleWPF.VML
{
    // Process for automatic hooking up viewModel with a View
    public class ViewModelLocator
    {
        ...
        // event handler contains automatic process for hooking up viewMOdel for View
